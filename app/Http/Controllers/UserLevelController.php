...
class UserLevelController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'INSERT', 'User Level', $result['data']['id']]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $header = $request->header('Authorization');
        $token = substr($header, 7);
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'UPDATE', 'User Level', $result['data']['id']]);
    ...
    public function delete($id, Request $request)
    {
        ...
        $header = $request->header('Authorization');
        $token = substr($header, 7);
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'DELETE', 'User Level', $id]);
