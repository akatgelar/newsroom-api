...
class SliderController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        $count_slug = Slider::where([['title', '=', $data['title']]])->count('id');
        if($count_slug > 0) {
            $count_slug += 1;
        ...
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'INSERT', 'Slider', $result['data']['id']]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $header = $request->header('Authorization');
        $token = substr($header, 7);
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'UPDATE', 'Slider', $result['data']['id']]);
    ...
    public function delete($id, Request $request)
    {
        ...
        $header = $request->header('Authorization');
        $token = substr($header, 7);
        app()->call('App\Http\Controllers\LogController@InsertLog', [$token, 'DELETE', 'Slider', $id]);
